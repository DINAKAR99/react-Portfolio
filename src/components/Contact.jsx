    ...
    emailjs
      .send(
        ...
        "template_i0xj4p8",
        {
          ...
          to_email: "barkaKarengula Dinakar13@gmail.com",
    ...
    >
      ...
      >
        ...
        <div class="flex mt-10 gap-5 justify-center">
          ...
          <a
            class="ml-3 text-gray-500"
            href="https://twitter.com/Karengula Dinakarbarka1"
            target="_blank"
            rel="noopener noreferrer"
          >
            <svg
          ...
          <a
            class="ml-3 text-gray-500"
            href="https://www.instagram.com/b.Karengula Dinakar.13/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <svg
          ...
          <a
            class="ml-3 text-gray-500"
            href="https://www.linkedin.com/in/Karengula Dinakar13"
            target="_blank"
            rel="noopener noreferrer"
          >
            <svg
